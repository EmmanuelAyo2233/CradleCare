                    ...
                    <div class="col-lg-8 offset-lg-2">
                        <form method = "post" action ="controller.php">
                            <div class="row">
                                ...
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="email" name = "email" required@gmail.com>
                                    </div>
                                </div>
								<div class="col-sm-6">
                                    <div class="form-group">
                                ...
                                <div class="col-sm-6">
								 ...
								 <div class="col-sm-6">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" type="text" name = "nextofkin" required>
                                    </div>
                                </div>
                                <div class="col-sm-6">
                                    <div class="form-group">
                                        <label>Next of Kin Phone No.<span class="text-danger">*</span></label>
                                        <input class="form-control" type="text" name = "phone_k" required>
                                    </div>
                                </div>
								<div class="col-sm-12">
									<div class="row">
									...
									<div class="col-sm-6 col-md-6 col-lg-6">
											<div class="form-group">
												...
												<select class="form-control select" name = "gynotype" required>
                            ...
                            <div class="m-t-20 text-center">
                                <button class="btn btn-primary submit-btn" name = "signUp">Sign Up</button>
                            </div>
                        </form>
                    </div>
                </div>
