            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-sm-7 col-8 text-right m-b-30">
						...
						<a href="add-paymennt.php" class="btn btn-success btn-rounded"><i class="fa fa-plus"></i> Make Payment</a>
                    </div>
                            ...
                            <table class="table table-striped custom-table mb-0">
								...
								<?php foreach ($rows as $row): ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo "NGN ".number_format($row['total_amount'])?></td>
										<?php
                                        ...
                                        <td class="text-right">
                                            <div class="dropdown dropdown-action">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    <a class="dropdown-item" href="invoice-view.php?invoiceNumber=<?php echo $row['invoice_id'] ?>"><i class="fa fa-eye m-r-5"></i> View</a>
